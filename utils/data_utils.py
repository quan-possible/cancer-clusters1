...
# def get_gen(X, y, configs, batch_size, validation=False, ae=False, ae_class=False, shuffle=True):
...
#         if ae_class:
#             data_gen = DataGen(X, y, 4, augment=True, ae=ae, ae_class=ae_class, batch_size=batch_size, shuffle=shuffle)
#         else:
#             data_gen = DataGen(X, y, num_clusters, augment=True, ae=ae, ae_class=ae_class, batch_size=batch_size, shuffle=shuffle)
#     else:
#         if ae_class:
#             data_gen = DataGen(X, y, 4, ae=ae, ae_class=ae_class, batch_size=batch_size, shuffle=shuffle)
#         else:
#             data_gen = DataGen(X, y, num_clusters, ae=ae, ae_class=ae_class, batch_size=batch_size, shuffle=shuffle)
#     return data_gen
...
#     elif args.data == "sim":
#         X, t, e, c, Z, mus, sigmas, betas, betas_0, mlp_dec = simulate_nonlin_profile_surv(p=1000, n=60000,
#                                                                                            latent_dim=16, k=3,
...
#         x_train, x_test, t_train, t_test, d_train, d_test, c_train, c_test = train_test_split(X, t, e, c, test_size=.3,
